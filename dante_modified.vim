...
" Generated by http://bytefluent.com/vivify 2016-07-12
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi DiffText guifg=NONE guibg=#870000 guisp=#870000 gui=bold ctermfg=NONE ctermbg=88 cterm=bold
...
hi DiffDelete guifg=#000000 guibg=#5f00d7 guisp=#5f00d7 gui=bold ctermfg=NONE ctermbg=56 cterm=bold
...
hi DiffChange guifg=#000000 guibg=#87005f guisp=#87005f gui=NONE ctermfg=NONE ctermbg=89 cterm=NONE
...
hi DiffAdd guifg=#000000 guibg=#0000af guisp=#0000af gui=NONE ctermfg=NONE ctermbg=19 cterm=NONE
