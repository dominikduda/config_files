...
" Generated by http://bytefluent.com/vivify 2016-04-11
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Normal guifg=#a6a6a6 guibg=#0a0a0a guisp=#0a0a0a gui=NONE ctermfg=248 ctermbg=232 cterm=NONE
...
hi Special guifg=#e67700 guibg=NONE guisp=NONE gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
...
hi PreProc guifg=#00719e guibg=NONE guisp=NONE gui=NONE ctermfg=31 ctermbg=NONE cterm=NONE
...
hi SpellCap guifg=#fa6161 guibg=NONE guisp=NONE gui=underline ctermfg=9 ctermbg=NONE cterm=underline
...
hi SpellBad guifg=#ff4747 guibg=NONE guisp=NONE gui=underline ctermfg=203 ctermbg=NONE cterm=underline
